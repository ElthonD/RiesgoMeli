...
def createPage():
    ...
    def load_df():
        ...
        rEmbarques = './data/Salidas Mercadolibre.xlsx'
    ...
    def ld_AR():
        rutaAR = './data/Anomalias Robos Mercadolibre.xlsx'
    ...
    @st.cache_resource
    def load_model():
        return pickle.load(open('proba_robo_mercadolibre.pkl', 'rb'))
    
    try:
        
        #Modulo de Predictivo
        st.markdown("<h3 style='text-align: left;'>Paso 1: % Riesgo de los Servicios Mercadolibre</h3>", unsafe_allow_html=True)

        st.write(""" 
        Pasos a seguir para este módulo:
        1. Descargar archivo **"BITÁCORAS"** (Prebitácoras) de **Mercadolibre** del **Área de Centro de Monitoreo** del **PowerBI**, en el **Reporte CM**, sección **Prebitácoras**.
        ...
        #Modulo de Chatbot
        st.write(""" 
        La finalidad de este módulo es validar el patrón de anomalías que se han presentando en los robos de Mercadolibre dependiendo de su origen y destino. 
        """)
        df_ar = ld_AR()
