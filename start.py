...
def createPage():
    ...
    col2.markdown('Bienvenido a ***Aplicación Táctico-Estrátegico AI27 Mercadolibre***, está aplicación provee los pasos tácticos-estrátegicos a seguir para la operación del cliente ***Mercadolibre***')
